...
TARGET_BACKBONE = "convnext_tiny"
TARGET_BACKBONE_TITLE = "ConvNeXt-Tiny"
...
SEARCH_SPACES: Dict[str, Dict[str, List[Any]]] = {
    TARGET_BACKBONE: {
        "img_size": [288, 320, 352],
        "batch_size": [16, 12, 8],
        "learning_rate": [7e-4, 1e-3, 1.5e-3],
...
# ============================================================
# CLI (standalone for ConvNeXt-Tiny)
# ============================================================
def build_fixed_backbone_parser() -> argparse.ArgumentParser:
    """
    이 파일은 ConvNeXt-Tiny 전용 탐색기입니다.
    따라서 backbone 인자는 따로 받지 않고, 내부에서 TARGET_BACKBONE을 고정 사용합니다.
    """
    parser = argparse.ArgumentParser(description="Standalone hyperparameter search for ConvNeXt-Tiny")
    parser.add_argument("--mode", choices=["holdout", "cv"], default="holdout")
