...
TARGET_BACKBONE = "resnet50"
TARGET_BACKBONE_TITLE = "ResNet50"
...
# ============================================================
# CLI (standalone for ResNet50)
# ============================================================
def build_fixed_backbone_parser() -> argparse.ArgumentParser:
    """
    이 파일은 ResNet50 전용 탐색기입니다.
    따라서 backbone 인자는 따로 받지 않고, 내부에서 TARGET_BACKBONE을 고정 사용합니다.
    """
    parser = argparse.ArgumentParser(description="Standalone hyperparameter search for ResNet50")
    parser.add_argument("--mode", choices=["holdout", "cv"], default="holdout")
